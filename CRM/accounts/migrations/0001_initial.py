# Generated by Django 2.2.12 on 2020-06-06 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Indoor', 'Na zewnąrz domu'), ('Out Door', 'Do domu')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_created', models.DateTimeField(auto_now_add=True, null=True)),
                ('status', models.CharField(choices=[('Pending', 'Oczekujące'), ('Out for delivery', 'Wysłane'), ('Delivered', 'Dostarczone')], max_length=200, null=True)),
